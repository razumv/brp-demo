...
export const initialDemoState: DemoState = {
  ...
  customers: [
    {
      id: "logos-client-2026-07-18",
      name: "ТОВ Логос Сервіс",
      phone: "+380000000000",
      email: "service@logos.example",
      address: "Київ, сервісний центр",
      notes: "Замовлення очікує перевірки менеджером.",
  ...
  orders: [
    {
      ...
      company: "Logos",
      creator: "Финансы",
      customerId: "logos-client-2026-07-18",
      po: "LOGOS-20260718",
      note: "Перевірити наявність і термін постачання перед підтвердженням.",
      delivery: "standard",
      status: "new",
      ...
      lines: [
        {
          ...
          dealerPrice: 13.09,
          source: "warehouse",
          privateNote: "Картку позиції перевірено менеджером.",
        },
      ],
      messages: [
        {
          ...
          author: "Финансы",
          role: "dealer",
          body: "Просимо підтвердити доступний термін постачання.",
