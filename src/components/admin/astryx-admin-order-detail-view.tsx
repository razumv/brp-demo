...
export function AstryxAdminOrderDetailView({model, onReady}: Props) {
  ...
  return <main className={styles.page} data-admin-order-detail-renderer="astryx">
    <div className={styles.stack}>
      ...
      <Banner title="Адміністративні дії недоступні" status="warning" icon={<LockKeyhole size={16} />} description="Доступні локальні фільтри, розкриття панелей і перевірка без підтвердження." />
