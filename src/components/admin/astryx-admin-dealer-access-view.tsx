...
export default function AstryxAdminDealerAccessView(props: Props) {
  ...
  return <AstryxBrpUiProvider><main className={styles.page} data-admin-dealer-access-renderer="astryx">
    ...
    <section><div className={styles.permissionHeader}><Heading level={2}>Політика компанії</Heading></div><AdminPermissionMatrix actions={dealerPermissionActions} rows={policyRows(props.visiblePermissionGroups)} ariaLabel="Політика компанії" emptyCopy="Немає доступних дилерських прав"/></section>
